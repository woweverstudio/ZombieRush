...
extension SpiritType {
    ...
    var localizedDisplayName: String {
        ...
        case .thunder:
            return NSLocalizedString("spirit_thunder_name", tableName: "Models", comment: "Thunder spirit display name")
        case .dark:
    ...
    var localizedDescription: String {
        ...
        case .thunder:
            return NSLocalizedString("spirit_thunder_description", tableName: "Models", comment: "Thunder spirit description")
        case .dark:
